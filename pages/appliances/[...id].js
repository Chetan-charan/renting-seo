...
const ItemDetail = ({item}) => {
    ...
    <div className={itemStyle.itemdetails}>
      <div>
        ...
        <Button style={stylesButton} onClick={() => {router.push('/appliances')}} variant="outlined">
            Go back
          </Button>
      </div>
    </div>
...
export const getStaticProps = async (context) => {
    ...
    const res = await fetch(`https://equipment-renting.herokuapp.com/appliances/item/${context.params.id[1]}`)
