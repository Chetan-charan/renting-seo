...
const ItemDetail = ({item}) => {
    ...
    <div className={itemStyle.itemdetails}>
      <div>
        ...
        <Button style={stylesButton} onClick={() => {router.push('/furniture')}} variant="outlined">
            Go back
          </Button>
      </div>
    </div>
...
export const getStaticProps = async (context) => {
    ...
    const res = await fetch(`https://equipment-renting.herokuapp.com/furniture/item/${context.params.id[1]}`)
